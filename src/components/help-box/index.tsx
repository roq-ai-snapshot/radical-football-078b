...
export const HelpBox: React.FC = () => {
  ...
  const applicationName = 'radical-football74';
...
2. As a Player, I want to be able to view my assigned training plans, so I can work on improving my skills and performance.
...
2. As a Parent, I want to be able to communicate with my child's coach through the platform, so I can ask questions, provide feedback, and address any concerns.
3. As a Parent, I want to be able to view my child's team schedule, so I can stay informed about practices, games, and other events.`;
